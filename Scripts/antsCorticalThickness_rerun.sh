...
GRAY_MATTER_MASK=${OUTPUT_PREFIX}GrayMatterMask.${OUTPUT_SUFFIX}
WHITE_MATTER_MASK=${OUTPUT_PREFIX}WhiteMatterMask.${OUTPUT_SUFFIX}
...
if [[ ! -f ${CORTICAL_THICKNESS_IMAGE} ]];
  then
    ...
    logCmd ${ANTSPATH}/ThresholdImage ${DIMENSION} ${CORTICAL_THICKNESS_SEGMENTATION} ${GRAY_MATTER_MASK} ${GRAY_MATTER_LABEL} ${GRAY_MATTER_LABEL}
    logCmd ${ANTSPATH}/ThresholdImage ${DIMENSION} ${CORTICAL_THICKNESS_SEGMENTATION} ${WHITE_MATTER_MASK} ${WHITE_MATTER_LABEL} ${WHITE_MATTER_LABEL}

    logCmd ${ANTSPATH}/ImageMath ${DIMENSION} ${CORTICAL_THICKNESS_GM} m ${CORTICAL_THICKNESS_GM} ${GRAY_MATTER_MASK}
    logCmd ${ANTSPATH}/ImageMath ${DIMENSION} ${CORTICAL_THICKNESS_WM} m ${CORTICAL_THICKNESS_WM} ${WHITE_MATTER_MASK}

    #TMP_FILES=( $CORTICAL_THICKNESS_GM $CORTICAL_THICKNESS_WM $CORTICAL_THICKNESS_SEGMENTATION ${GRAY_MATTER_MASK} ${WHITE_MATTER_MASK} )
